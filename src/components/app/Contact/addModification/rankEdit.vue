        ...
        <div class="set-content">
          <el-form label-width="70px">
            ...
            <el-form-item label="所属公司">
              <el-select v-model="form.selectedPost" placeholder="请选择">
                <el-option
...
export default {
  ...
  methods: {
    ...
    determineEdit () {
      ...
      let data = {}
      Vue.set(data, 'name', this.form.name) // 职级名称
      Vue.set(data, 'company_id', this.form.selectedPost) // 所属公司
      ...
      axios.post('/api/contact/editRank', data)
        .then(res => {
          let data = res.data
          if (data.ret) {
            this.getUserList()
  ...
  mounted () {
    ...
    if (this.data.data) {
      ...
      this.form.selectedPost = this.data.data.company_id
